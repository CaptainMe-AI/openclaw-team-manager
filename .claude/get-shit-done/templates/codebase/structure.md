...
- Usage: Reference from command with `@/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/vel/development/vlss/et/openclaw-team-manager/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/vel/development/vlss/et/openclaw-team-manager/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
