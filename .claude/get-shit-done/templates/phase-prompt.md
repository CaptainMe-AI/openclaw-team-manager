...
<!-- For checkpoint task examples and patterns, see @/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
