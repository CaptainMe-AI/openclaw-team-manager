...
```bash
integration_checker_model=$(node "/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-integration-checker --raw)
```
...
node "/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/bin/gsd-tools.cjs" phases list
```
...
PHASE_INFO=$(node "/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract "$summary" --fields requirements_completed --pick requirements_completed
done
```
...
```bash
NYQUIST_CONFIG=$(node "/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/bin/gsd-tools.cjs" config-get workflow.nyquist_validation --raw 2>/dev/null)
```
