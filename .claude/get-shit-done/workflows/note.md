...
- **Global scope**: `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/notes/`)
...
2. Glob `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/vel/development/vlss/et/openclaw-team-manager/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/vel/development/vlss/et/openclaw-team-manager/.claude/notes/` — works in any directory
