...
<required_reading>
@/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/vel/development/vlss/et/openclaw-team-manager/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
