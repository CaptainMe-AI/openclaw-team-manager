...
Plans:
- [ ] 04-01-PLAN.md -- Database models, migrations, factories, model specs, Pagy config, seed data
- [ ] 04-02-PLAN.md -- Service layer, API controllers, jbuilder views, routes, request specs
